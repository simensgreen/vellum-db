...
import { VISUAL_COLUMN_TYPE_LABELS, VISUAL_COLUMN_TYPES } from "../table-definition-editor/types.ts"
    ...
    return (
        <label class="form-field">
            ...
            <select
                value={typeName}
                onChange={(event) =>
                    onSwitchType((event.target as HTMLSelectElement).value as ColumnData["type"])
                }
            >
        ...
        <div class="column-type-fields">
            {typeName === "str" ? (
                <>
                    ...
                    {data.minLen !== undefined || data.maxLen !== undefined || data.regex?.regex ? (
                ...
                <div class="column-type-fields__row">
                    ...
                    <div class="form-field">
                        ...
                        <ButtonSwitch
                            ...
                            onPressedChange={(pressed) => onChange({ ...data, default: pressed })}
                        />
                    </div>
                </div>
            ) : null}
