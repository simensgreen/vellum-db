...
export function CreateTableForm({
    ...
    const [draftColumn, setDraftColumn] = useState<VisualColumn>(() => emptyVisualColumn())
    ...
    function mergeColumnPatch(column: VisualColumn, patch: Partial<VisualColumn>): VisualColumn {
    ...
    function updateDraftColumn(patch: Partial<VisualColumn>, nameCursor?: number): void {
    ...
    async function handleSubmit(event: Event): Promise<void> {
        ...
        try {
            ...
            setError(submitError instanceof Error ? submitError.message : "Failed to create table")
        } finally {
            setSubmitting(false)
        }
    }
                    ...
                    <ColumnCardEditor
                        ...
                        onUpdate={(patch) => {
                            if (patch.name !== undefined) {
                                ...
                                updateDraftColumn(patch, input?.selectionStart ?? patch.name.length)
                                return
                            }
