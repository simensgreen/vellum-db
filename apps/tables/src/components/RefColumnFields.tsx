        ...
        <div class="ref-column-fields">
            <label class="form-field">
                ...
                <select
                    ...
                    onChange={(event) => {
                        ...
                        const target = refTargets.find((entry) => entry.tableSlug === nextTable)
                        onChange({
                            table: nextTable,
            ...
            <label class="form-field">
                ...
                <select
                    ...
                    onChange={(event) =>
                        onChange({
                            onDelete: (event.target as HTMLSelectElement).value as RefOnDelete
                        })
                    }
                >
            ...
            <label class="form-field">
                ...
                <select
                    ...
                    onChange={(event) =>
                        onChange({
                            onUpdate: (event.target as HTMLSelectElement).value as RefOnUpdate
                        })
                    }
                >
                    <option value="restrict">restrict</option>
